...
getting-started: ## Getting Started
	...
	@echo '13: make show-table-counts'
	@echo '14: make show-tables'
	@echo '15: make clean-logs'
	@echo '16: benchmark(ボタンポチ)'
	@echo '17: make download-and-analyze-logs'
	@echo '- make alp-result'
	@echo '- make slow-query-result'
	@echo '- scripts/download-and-analyze-logs.shのalpの-mオプションを調整(パスなどを正規表現で調整)'
	@echo '18: make show-table-counts(ベンチマーク後、user数が増えているはず)'
	@echo '19: make show-tables'
	@echo '20: 改善 → git push → 11や13へ'
	@echo '----'
