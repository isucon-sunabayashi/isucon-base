...
getting-started: ## Getting Started
	...
	@echo '08: make download'
	@echo '09: make switch-to-golang-isu-app'
	@echo '10: 手動: ssh isu-1をしてgolangのappをビルドする方法をdeploy-app.shに反映、09の空deployできるまで'
	@echo '11: make deploy-app'
	@echo '12: make setup-1st-bench'
	@echo '13: make deploy-config'
	@echo '14: make clean-logs'
	@echo '15: 手動: 1st benchmark'
	@echo '16: show-table-counts'
	@echo '17: 1st benchmark'
	@echo '18: show-table-counts'
	@echo '19: show-tables'
